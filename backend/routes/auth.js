            ...
            <table role="presentation" cellpadding="0" cellspacing="0" style="margin:0 auto 24px;">
              <tr>
                <td style="background:#E6F5F4;border-radius:12px;padding:18px 36px;">
                  <h1 style="margin:0;font-size:34px;letter-spacing:8px;font-weight:700;color:#007A74;font-family:-apple-system,BlinkMacSystemFont,'Segoe UI',Roboto,Arial,sans-serif;">${verificationCode}</h1>
                </td>
              </tr>
            </table>
        ...
        <tr>
          <td align="center" style="padding:36px 32px 32px;">
            ...
            <table role="presentation" cellpadding="0" cellspacing="0" style="margin:0 auto 24px;">
              <tr>
                <td style="background:#E6F5F4;border-radius:12px;padding:18px 36px;">
                  <h1 style="margin:0;font-size:34px;letter-spacing:8px;font-weight:700;color:#007A74;font-family:-apple-system,BlinkMacSystemFont,'Segoe UI',Roboto,Arial,sans-serif;">${newCode}</h1>
                </td>
              </tr>
            </table>
            <p style="margin:0;font-size:13px;color:#9CA3AF;font-family:-apple-system,BlinkMacSystemFont,'Segoe UI',Roboto,Arial,sans-serif;">This code expires in <b style="color:#23736F;">10 minutes</b></p>
